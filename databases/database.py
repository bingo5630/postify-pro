...
class Rohit:
    ...
    # ========== FSUB BUTTON LINKS MANAGEMENT (/byt /ryt /lyt) ==========
    async def add_fsub_button_link(self, link: str):
        """Add a link for /byt command (ForceSub button links)"""
